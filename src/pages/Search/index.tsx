		...
		( async () => {
			try {
				let weatherRes: Response = await fetch(
					`https://api.openweathermap.org/data/2.5/weather?q=${ query }&appid=290019881de2a3d63903f8424b57849f&units=metric`
				);
				...
				let forecastRes: Response = await fetch(
					`https://api.openweathermap.org/data/2.5/onecall?lat=${ coords.lat }&lon=${ coords.lon }&appid=290019881de2a3d63903f8424b57849f&exclude=minutely&units=metric`
				);
