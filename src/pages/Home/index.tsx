				...
				async ( { coords } ) => {
					try {
						let weatherRes: Response = await fetch(
							`https://api.openweathermap.org/data/2.5/weather?lat=${ coords.latitude }&lon=${ coords.longitude }&appid=290019881de2a3d63903f8424b57849f&units=metric`
						);
						...
						let forecastRes: Response = await fetch(
							`https://api.openweathermap.org/data/2.5/onecall?lat=${ coords.latitude }&lon=${ coords.longitude }&appid=290019881de2a3d63903f8424b57849f&exclude=minutely&units=metric`
						);
